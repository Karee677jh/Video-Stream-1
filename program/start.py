...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "👥 البشمبرمج هيروين", url=f"https://t.me/cf_ry"
                    ),
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "🌐 البشمبرمج ديشا", url="https://t.me/EM_96"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("✨ البشمبرمج ديشا", url=f"https://t.me/EM_96"),
                InlineKeyboardButton(
...
async def ping_pong(client: Client, message: Message):
    ...
    await m_reply.edit_text("🏓 `البينج مظبوط يكيمو!!`\n" f"⚡️ `{delta_ping * 1000:.3f} ms`")
        ...
        if member.id == bot_id:
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("📣 جروب السورس", url=f"https://t.me/Ba7bk74"),
